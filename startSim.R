...
if(length(args)>0)  { ## Then cycle through each element of the list and evaluate the expressions.
    ...
    seed=120;trial="SWCT";hazType="Phenom";weeklyDecay=0.9;cvWeeklyDecay=1;cvClusTime=1;cvClus=1.8;ord="none";propInTrial=0.1;sdLogIndiv=1;delayUnit=7;immunoDelay=21;vaccEff=0;simNum=5400;batchdirnm="BigResults/FalsePosFluct";saveNm="simFP-pit75-";nsims=1;reordLag=14;nboot=10;trialStartDate="2015-02-18";
}
