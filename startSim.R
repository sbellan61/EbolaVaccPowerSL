...
## seed=1;trial="CRCT";ord="none";propInTrial=0.03;sdLogIndiv=1;delayUnit=0;vaccEff=0;simNum=1717;batchdirnm="BigResults/SLSims3";saveNm="simSL-3-";nsims=11;reordLag=14
## parmArgs <- subsArgs(as.list(environment()), makeParms)
