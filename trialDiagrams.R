...
p <- ggplot(dat) +
  ...
  scale_alpha_manual(values = c(1, 0.5, 0.4), drop = F, name="participant status") +
  theme(
...
for(ii in 1:2) {
if(ii ==1) pdf('Figures/Fig 1 schematic.pdf', w = 3.5, h = 9)
if(ii ==2) png('Figures/Fig 1 schematic.png', w = 3.5, h = 9, units='in', res = 200)
grid_arrange_shared_legend(SWT, OrigOrderRCTtu, ncol = 1)
graphics.off()
}


for(ii in 1:2) {
if(ii ==1) pdf('Figures/Fig S4 schematic.pdf', w = 3.5, h = 9)
if(ii ==2) png('Figures/Fig S4 schematic.png', w = 3.5, h = 9, units='in', res = 200)
grid_arrange_shared_legend(SWT, OrigOrderRCTtu, FRCT, ncol = 1)
graphics.off()
}
